...
Shape::Shape(Component* const parent, const Vector2& position, const Color& color, const float outline_thickness, const Color& outline_color) noexcept
    ...
    color(create_default_exponential_interpolation(color)),
    outline_thickness(create_default_exponential_interpolation(outline_thickness)),
    outline_color(create_default_exponential_interpolation(outline_color))
{}
